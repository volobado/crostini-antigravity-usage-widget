...
On Windows, provides a system tray icon with live quota gauge and background menu.
On Linux / ChromeOS, gracefully degrades (as ChromeOS / Linux shelf has no Win32 tray).
"""
...
if sys.platform != "win32":
    ...
    class Tray:
        ...
        def update(self, fraction: float | None, color, tooltip: str) -> None:
            pass
